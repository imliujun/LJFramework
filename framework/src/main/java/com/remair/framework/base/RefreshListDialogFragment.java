 ...
 * 类描述：
 * 创建人：LiuJun
 * 创建时间：2017/4/14 17:39
 * 修改人：LiuJun
 * 修改时间：2017/4/14 17:39
 * 修改备注：
 */
public abstract class RefreshListDialogFragment<M, P extends IPresenter> extends BaseMVPDialogFragment<P> {
    @Nullable @BindView(R2.id.ptrFrameLayout) PtrFrameLayout mPtrFrameLayout;
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container) {
        ...
        mViewBinding = new RefreshListDialogFragment_ViewBinding(this, view);
