 ...
 * 类描述：
 * 创建人：LiuJun
 * 创建时间：2017/4/13 17:08
 * 修改人：LiuJun
 * 修改时间：2017/4/13 17:08
 * 修改备注：
 */
public abstract class RefreshListActivity<M, P extends IPresenter> extends BaseMVPActivity<P> {

    @Nullable @BindView(R2.id.title_left_image) protected ImageButton mTitleLeftImage;
    ...
    protected void initData(Bundle savedInstanceState) {
        mViewBinding = new RefreshListActivity_ViewBinding(this);

        if (mTitleLeftImage != null) {
            RxViewUtil.viewBindClick(mTitleLeftImage, new Consumer<Object>() {
                @Override
        ...
        if (mPtrFrameLayout != null) {
            ...
            LoadingRefreshHeader mHeaderView = new LoadingRefreshHeader(this);
